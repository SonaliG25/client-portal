...
//     // Update formData.attachments as well to keep it in sync
...
//         `http://localhost:3000/ticket/new`,
//         {
...
//       navigate(-1);
//     } catch (error) {
//       toast.error("Error Ticket created TRY Again");
//       console.log("Error Ticket created", error);
//     }
//     // }
...
//                     Supported formats: PDF, DOC, DOCX, etc.and Images Max size:
//                     5MB.
//                   </small>
...
const CreateTicket = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    client: {
      ...
      name: auth.user.role || "", // Assuming name is available in auth.user
